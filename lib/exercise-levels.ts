...
/*
 * THERE ARE NO SELF-CHECK QUESTIONS HERE ANY MORE.
 *
 * Six of them used to live beside the patterns above, one per ladder, asked on
 * a session card of anybody who had skipped the builder's movement screen, from
 * Level 3 up. Both the screen and the card are gone: what a person says about
 * their own plank is how they feel about their plank, and the ceiling now comes
 * from the experience answer alone. See atEarnedLevel in lib/workout-engine.ts.
 */
