...
export interface ExerciseTemplate {
  ...
  movementPattern?: 'squat' | 'hinge' | 'push' | 'pull' | 'carry' | 'lunge' | 'rotation' | 'isometric' | 'conditioning';
  ...
  squat: {
    bodyweight: [
      { id: 'sq-mech-bw-1', name: 'Banded Clamshell', sets: 3, reps: '20 each', cue: 'Heels together, rotate top knee up - constant tension', suggestedLoad: 'Light band', category: 'mechanical', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'rotation', primaryMuscle: 'Glute medius', secondaryMuscles: ['Hip external rotators'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'sq-mech-bw-2', name: 'Glute Bridge Pulse', sets: 3, reps: '25 pulses', cue: 'Small pulsing reps at top - feel the glutes burn, no rest', suggestedLoad: 'Bodyweight', category: 'mechanical', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core'], difficulty: 'beginner', isUnilateral: false,
    ...
    dumbbells: [
      ...
      { id: 'sq-mech-db-2', name: 'Goblet Squat Primer', sets: 3, reps: '15 slow', cue: '3s down, pause 1s, drive up - just activation weight', suggestedLoad: '8–12 kg per hand', category: 'mechanical', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Adductors', 'Core'], difficulty: 'beginner', isUnilateral: false,
  ...
  bench: {
    bodyweight: [
      { id: 'bn-mech-bw-1', name: 'Band Pull-Apart', sets: 3, reps: '20', cue: 'Arms straight, squeeze shoulder blades - pause 1s at chest', suggestedLoad: 'Light band', category: 'mechanical', targetRegions: ['rear_shoulder', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Rear deltoid', 'Trapezius'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-mech-bw-2', name: 'Scapular Push-Up', sets: 3, reps: '15', cue: 'Arms straight, protract scaps forward then retract back - no elbow bend', suggestedLoad: 'Bodyweight', category: 'mechanical', targetRegions: ['front_shoulder', 'rear_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Serratus anterior', secondaryMuscles: ['Rhomboids', 'Trapezius'], difficulty: 'beginner', isUnilateral: false,
    ...
    dumbbells: [
      ...
      { id: 'bn-mech-db-2', name: 'Light DB External Rotation', sets: 3, reps: '15 each', cue: 'Elbow pinned to side, rotate out slowly - constant tension', suggestedLoad: '2–4 kg per hand', category: 'mechanical', targetRegions: ['front_shoulder', 'rear_shoulder'], videoId: '',
        movementPattern: 'rotation', primaryMuscle: 'Infraspinatus', secondaryMuscles: ['Teres minor', 'Rear deltoid'], difficulty: 'beginner', isUnilateral: true,
    ...
    fullgym: [
      ...
      { id: 'bn-mech-fg-2', name: 'Face Pull', sets: 3, reps: '15', cue: 'Pull to forehead, externally rotate at end position', suggestedLoad: 'Light cable', category: 'mechanical', targetRegions: ['rear_shoulder', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rear deltoid', secondaryMuscles: ['Rhomboids', 'External rotators'], difficulty: 'beginner', isUnilateral: false,
  ...
  deadlift: {
    bodyweight: [
      ...
      { id: 'dl-mech-bw-2', name: 'Bird Dog', sets: 3, reps: '10 each', cue: 'Opposite arm + leg, spine neutral - squeeze glute as leg extends', suggestedLoad: 'Bodyweight', category: 'mechanical', targetRegions: ['lower_back', 'core_ribs'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Erector spinae', secondaryMuscles: ['Glutes', 'Core', 'Shoulder stabilizers'], difficulty: 'beginner', isUnilateral: true,
    ...
    dumbbells: [
      ...
      { id: 'dl-mech-db-2', name: 'KB Deadbug', sets: 3, reps: '10 each', cue: 'Press KB to ceiling, extend opposite leg - low back flat into floor', suggestedLoad: '4–8 kg per hand', category: 'mechanical', targetRegions: ['core_ribs', 'lower_back'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Obliques', 'Hip flexors'], difficulty: 'beginner', isUnilateral: true,
    ...
    fullgym: [
      ...
      { id: 'dl-mech-fg-2', name: 'Banded Good Morning', sets: 3, reps: '15', cue: 'Band around neck, hinge at hips - feel hamstrings load at bottom', suggestedLoad: 'Medium band', category: 'mechanical', targetRegions: ['lower_back', 'hip_groin'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Erector spinae', 'Glutes'], difficulty: 'beginner', isUnilateral: false,
...
const NEURO: Record<MainSessionType, Record<InternalTier, ExerciseTemplate>> = {
  squat: {
    bodyweight: {
      ...
      movementPattern: 'squat', primaryMuscle: 'Glutes', secondaryMuscles: ['Quadriceps', 'Hamstrings', 'Calves'], difficulty: 'intermediate', isUnilateral: false,
    ...
    dumbbells: {
      ...
      movementPattern: 'squat', primaryMuscle: 'Glutes', secondaryMuscles: ['Quadriceps', 'Calves', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: false,
  ...
  bench: {
    bodyweight: {
      ...
      movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid'], difficulty: 'intermediate', isUnilateral: false,
  ...
  deadlift: {
    bodyweight: {
      ...
      movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Quadriceps', 'Calves'], difficulty: 'intermediate', isUnilateral: false,
    ...
    dumbbells: {
      ...
      movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Erector spinae', 'Core'], difficulty: 'intermediate', isUnilateral: false,
...
const MAIN_LIFTS: Record<MainSessionType, Record<InternalTier, ExerciseTemplate>> = {
  squat: {
    bodyweight: {
      ...
      videoId: '',
      movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings', 'Adductors'], difficulty: 'beginner', isUnilateral: false,
    ...
    fullgym: {
      ...
      videoId: '',
      movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings', 'Erector spinae', 'Core'], difficulty: 'advanced', isUnilateral: false,
  ...
  bench: {
    bodyweight: {
      ...
      videoId: '',
      movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid', 'Serratus anterior'], difficulty: 'beginner', isUnilateral: false,
    ...
    fullgym: {
      ...
      videoId: '',
      movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid', 'Serratus anterior'], difficulty: 'advanced', isUnilateral: false,
  ...
  deadlift: {
    bodyweight: {
      ...
      videoId: '',
      movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Erector spinae', 'Core'], difficulty: 'intermediate', isUnilateral: true,
    ...
    dumbbells: {
      ...
      videoId: '',
      movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Erector spinae', 'Adductors'], difficulty: 'intermediate', isUnilateral: false,
    ...
    fullgym: {
      ...
      videoId: '',
      movementPattern: 'hinge', primaryMuscle: 'Erector spinae', secondaryMuscles: ['Glutes', 'Hamstrings', 'Trapezius', 'Core', 'Quadriceps'], difficulty: 'advanced', isUnilateral: false,
  ...
  squat: {
    bodyweight: [
      { id: 'sq-acc-bw-1', name: 'Reverse Lunge', sets: 3, reps: '15 each', cue: 'Step back, knee lightly taps floor, drive through front foot', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['knee', 'hip_groin'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-3', name: 'Banded Lateral Walk', sets: 3, reps: '15 each direction', cue: 'Stay low, knees out - continuous tension on band', suggestedLoad: 'Medium band', category: 'accessory', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'rotation', primaryMuscle: 'Glute medius', secondaryMuscles: ['Hip external rotators', 'Quadriceps'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-4', name: 'Wall Sit', sets: 2, reps: '45s', cue: 'Thighs parallel, back flat - breathe steadily', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['knee'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-5', name: 'Single-Leg Glute Bridge', sets: 3, reps: '12 each', cue: 'One foot planted, other leg extended - drive through heel to full hip extension', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['glutes', 'hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-6', name: 'Calf Raise', sets: 3, reps: '20', cue: 'Rise onto toes, full extension, 1s squeeze at top - slow 2s down', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['calf_shin'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Gastrocnemius', secondaryMuscles: ['Soleus'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-7', name: 'Nordic Hamstring Curl', sets: 3, reps: '6–8', cue: 'Anchor feet, lower torso slowly under control - resist with hamstrings the whole way', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Calves'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-8', name: 'Curtsy Lunge', sets: 3, reps: '12 each', cue: 'Step back and across, drop rear knee behind front foot - hits glute medius', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['glutes', 'hip_groin'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Glute medius', secondaryMuscles: ['Glutes', 'Quadriceps', 'Adductors'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-9', name: 'Sissy Squat', sets: 3, reps: '10–12', cue: 'Hold a support, lean back, knees drive forward over toes - quad isolation at full knee flexion', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['knee', 'quads'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Hip flexors'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-10', name: 'Lateral Lunge', sets: 3, reps: '12 each', cue: 'Wide step to side, sit into bent leg, keep other leg straight - feel inner thigh stretch', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Glutes', secondaryMuscles: ['Adductors', 'Quadriceps'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-11', name: 'Step-Up with Knee Drive', sets: 3, reps: '10 each', cue: 'Step up, drive opposite knee to chest at top - single-leg power and hip flexor demand', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['knee', 'hip_groin'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-12', name: 'Spanish Squat', sets: 3, reps: '45s hold', cue: 'Band anchored at knee height, lean back onto band, squat until thighs parallel - knees stay behind toes, let the band take the tibial load', suggestedLoad: 'Medium band', category: 'accessory', targetRegions: ['knee', 'quads'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Adductors'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-13', name: 'Single Leg Hip Thrust', sets: 3, reps: '12 each', cue: 'Shoulders on bench, one leg extended, drive through planted heel to full hip extension - squeeze glute hard at top', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-bw-14', name: 'Frog Pumps', sets: 3, reps: '25', cue: 'Lying on back, soles of feet together, knees out - drive hips up and squeeze glutes at top; short range, high reps, burn it out', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'glutes'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hip external rotators'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-15', name: 'Banded Glute Bridge', sets: 3, reps: '20', cue: 'Band above knees, drive hips up against band resistance - knees press out through the whole rep', suggestedLoad: 'Medium band', category: 'accessory', targetRegions: ['hip_groin', 'glutes', 'knee'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Glute medius', 'Hamstrings'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-bw-16', name: 'Cossack Squat', sets: 3, reps: '10 each', cue: 'Wide stance, shift weight to one leg bending that knee deeply while the other stays straight with heel down - full inner thigh and hip stretch', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'knee', 'ankle_achilles'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Adductors', secondaryMuscles: ['Glutes', 'Quadriceps', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: true,
    ...
    dumbbells: [
      { id: 'sq-acc-db-1', name: 'DB Bulgarian Split Squat', sets: 3, reps: '15 each', cue: 'Upright torso, front knee tracks toe - pump reps, lighter weight', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['knee', 'hip_groin'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-db-2', name: 'DB Hip Thrust', sets: 3, reps: '15', cue: 'DB on hips, full extension - 2s squeeze at top', suggestedLoad: '16–24 kg per hand', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-db-8', name: 'DB Sumo Squat', sets: 3, reps: '15', cue: 'Wide stance, toes out, hold DB between legs - sit straight down, knees track toes', suggestedLoad: '16–28 kg', category: 'accessory', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Adductors', secondaryMuscles: ['Glutes', 'Quadriceps'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-db-9', name: 'DB Single-Leg RDL', sets: 3, reps: '10 each', cue: 'Hinge on one leg, DB in opposite hand, reach toward floor until hamstring stretches - control the return', suggestedLoad: '8–16 kg', category: 'accessory', targetRegions: ['hamstrings', 'hip_groin'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Core'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-db-10', name: 'DB Lateral Lunge', sets: 3, reps: '12 each', cue: 'Hold DBs, step wide to side, sit into bent leg - stretch inner thigh, drive back up through heel', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['hip_groin', 'knee'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Adductors', secondaryMuscles: ['Glutes', 'Quadriceps'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-db-13', name: 'Weighted Plank', sets: 3, reps: '30–45s', cue: 'Forearms on floor, DB placed on lower back - brace hard, breathe steadily, hips level', suggestedLoad: '10–20 kg plate', category: 'accessory', targetRegions: ['core_ribs', 'lower_back'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Obliques', 'Glutes', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-db-14', name: 'Suitcase Carry', sets: 3, reps: '40m each side', cue: 'Heavy DB in one hand, walk tall resisting the lean - oblique and lateral core stability challenge', suggestedLoad: '20–36 kg', category: 'accessory', targetRegions: ['core_ribs', 'upper_back'], videoId: '',
        movementPattern: 'carry', primaryMuscle: 'Obliques', secondaryMuscles: ['Trapezius', 'Core', 'Grip/Forearms'], difficulty: 'intermediate', isUnilateral: true,
    ...
    fullgym: [
      { id: 'sq-acc-fg-1', name: 'Dumbbell Walking Lunge', sets: 3, reps: '12 each', cue: 'DBs at sides, controlled steps, upright torso - pump focus', suggestedLoad: '10–18 kg each hand', category: 'accessory', targetRegions: ['knee', 'hip_groin'], videoId: '',
        movementPattern: 'lunge', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings', 'Core'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'sq-acc-fg-2', name: 'Leg Press', sets: 3, reps: '15–20', cue: 'Full ROM, dont lock knees at top - slow 3s down', suggestedLoad: '80–120 kg', category: 'accessory', targetRegions: ['knee', 'hip_groin'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Hamstrings', 'Calves'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-3', name: 'Barbell Hip Thrust', sets: 3, reps: '15', cue: 'Full extension, 2s pause at top - squeeze glutes hard', suggestedLoad: '40–70 kg', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core', 'Adductors'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-4', name: 'Leg Extension', sets: 3, reps: '15–20', cue: 'Full extension, 1s squeeze at top - slow 3s negative, constant tension', suggestedLoad: '30–50 kg', category: 'accessory', targetRegions: ['quads', 'knee'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Quadriceps', secondaryMuscles: [], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-5', name: 'Leg Curl (Machine)', sets: 3, reps: '15', cue: 'Curl heels to glutes, 1s squeeze - slow 3s release, hips stay down', suggestedLoad: '30–50 kg', category: 'accessory', targetRegions: ['hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Calves'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-9', name: 'Cable Pull-Through', sets: 3, reps: '15', cue: 'Rope between legs from low cable, hinge forward, drive hips through - squeeze glutes and hamstrings hard at top', suggestedLoad: '20–35 kg', category: 'accessory', targetRegions: ['hip_groin', 'hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Lower back'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-11', name: 'Front Squat', sets: 3, reps: '8–10', cue: 'Bar in front rack or crossed-arm position, elbows high, squat deep - upright torso, knees out, tremendous quad demand', suggestedLoad: '40–70 kg', category: 'accessory', targetRegions: ['knee', 'quads', 'hip_groin'], videoId: '',
        movementPattern: 'squat', primaryMuscle: 'Quadriceps', secondaryMuscles: ['Glutes', 'Upper back', 'Core'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-12', name: 'Adductor Machine', sets: 3, reps: '15–20', cue: 'Seated, knees against pads, squeeze legs together - full range, 1s squeeze at peak, slow return', suggestedLoad: '30–60 kg', category: 'accessory', targetRegions: ['hip_groin'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Adductors', secondaryMuscles: ['Hip flexors'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-13', name: 'Ab Wheel Rollout', sets: 3, reps: '10–12', cue: 'Kneel, grip ab wheel, roll forward until arms extend, brace hard to pull back - do not let lower back arch', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs', 'lower_back'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Lats', 'Obliques'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-14', name: 'Hanging Leg Raise', sets: 3, reps: '12–15', cue: 'Dead hang on bar, raise legs to parallel or higher - brace core, no swinging, control the descent', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs', 'hip_groin'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Hip flexors', secondaryMuscles: ['Rectus abdominis', 'Obliques'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-15', name: 'Cable Crunch', sets: 3, reps: '15–20', cue: 'Kneel facing cable, rope at neck, curl spine toward knees - squeeze abs hard at bottom, resist cable on way up', suggestedLoad: '15–30 kg', category: 'accessory', targetRegions: ['core_ribs'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Rectus abdominis', secondaryMuscles: ['Obliques'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-16', name: "Farmers Carry (Heavy)", sets: 3, reps: '40m', cue: 'Hex bar or heavy dumbbells, walk with purpose - tall posture, core braced, grip the handles hard', suggestedLoad: '40–70 kg per hand', category: 'accessory', targetRegions: ['core_ribs', 'upper_back'], videoId: '',
        movementPattern: 'carry', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Trapezius', 'Core', 'Glutes'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-17', name: 'Back Extension', sets: 3, reps: '15', cue: 'Hips on GHD or hyperextension bench, torso hanging, hinge up to parallel - squeeze glutes at top, slow descent', suggestedLoad: 'Bodyweight + 10–20 kg plate', category: 'accessory', targetRegions: ['lower_back', 'glutes', 'hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Erector spinae', secondaryMuscles: ['Glutes', 'Hamstrings'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'sq-acc-fg-18', name: 'Good Morning', sets: 3, reps: '12', cue: 'Barbell on upper back, soft knees, hinge until torso near parallel - brace core hard, feel hamstrings load, drive hips through', suggestedLoad: '30–60 kg', category: 'accessory', targetRegions: ['lower_back', 'hamstrings', 'hip_groin'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Erector spinae', 'Glutes'], difficulty: 'intermediate', isUnilateral: false,
  ...
  bench: {
    bodyweight: [
      { id: 'bn-acc-bw-1', name: 'Diamond Push-Up', sets: 3, reps: '15–20', cue: 'Hands close together, elbows track back - feel the triceps', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['elbow_wrist', 'front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Pectorals', 'Anterior deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-2', name: 'Inverted Row (Table/Bar)', sets: 3, reps: '15', cue: 'Pull chest to bar, squeeze back at top - body plank-straight', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['rear_shoulder', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Latissimus dorsi', 'Biceps', 'Rear deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-3', name: 'Pike Push-Up', sets: 3, reps: '12', cue: 'Hips high, head through arms at bottom - vertical push pattern', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Triceps', 'Serratus anterior'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-4', name: 'Prone Y-T-W Raise', sets: 2, reps: '10 each', cue: 'Face down, lift arms in Y, T, W - squeeze each position for 1s', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['rear_shoulder', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Rear deltoid', 'Trapezius', 'Infraspinatus'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-5', name: 'Pull-Up / Chin-Up', sets: 3, reps: '6–10', cue: 'Full hang to chin over bar, control the descent - lats drive the pull', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['lat_mid_back', 'bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Biceps', 'Rhomboids', 'Core'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-6', name: 'Tricep Dips (Bench)', sets: 3, reps: '15', cue: 'Hands on bench behind, bend elbows to 90°, press up - keep hips close to bench', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['tricep', 'front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Anterior deltoid', 'Pectorals'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-7', name: 'Band Bicep Curl', sets: 3, reps: '20', cue: 'Stand on the band, elbows pinned, curl to shoulders - slow 2s negative', suggestedLoad: 'Medium band', category: 'accessory', targetRegions: ['bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Biceps', secondaryMuscles: ['Brachialis', 'Brachioradialis'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-9', name: 'Wide Push-Up', sets: 3, reps: '15–20', cue: 'Hands 1.5× shoulder width, chest to floor - shifts load to pecs, less tricep', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['front_shoulder', 'elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Front deltoid', 'Triceps'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-10', name: 'Archer Push-Up', sets: 3, reps: '8 each', cue: 'Wide hand position, shift weight to one arm while the other stays straight - challenging unilateral press', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['front_shoulder', 'elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid'], difficulty: 'advanced', isUnilateral: true,
      ...
      { id: 'bn-acc-bw-11', name: 'Australian Pull-Up', sets: 3, reps: '12–15', cue: 'Body under a table or bar at hip height, pull chest to bar - back and biceps pump', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Rhomboids', 'Biceps'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-12', name: 'Weighted Push-Up', sets: 3, reps: '10–15', cue: 'Plate or vest on upper back, standard push-up form - overload the press without any barbell', suggestedLoad: '10–20 kg plate', category: 'accessory', targetRegions: ['front_shoulder', 'elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Front deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-bw-13', name: 'Deficit Push-Up', sets: 3, reps: '10–12', cue: 'Hands on books or parallettes, lower chest below hand level - greater pec stretch at the bottom, full range of motion', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['front_shoulder', 'elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Serratus anterior'], difficulty: 'intermediate', isUnilateral: false,
    ...
    dumbbells: [
      { id: 'bn-acc-db-1', name: 'DB Single-Arm Row', sets: 3, reps: '15 each', cue: 'Pull to hip, squeeze lat - slow 3s down', suggestedLoad: '14–22 kg per hand', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Rhomboids', 'Biceps', 'Rear deltoid'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'bn-acc-db-2', name: 'DB Lateral Raise', sets: 3, reps: '15–20', cue: 'Slight forward lean, thumbs up - slow and controlled', suggestedLoad: '4–8 kg per hand', category: 'accessory', targetRegions: ['front_shoulder', 'rear_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Lateral deltoid', secondaryMuscles: ['Anterior deltoid', 'Trapezius'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-3', name: 'DB Tricep Overhead Extension', sets: 3, reps: '15', cue: 'Elbows forward, full ROM - slow negative', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Anterior deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-4', name: 'DB Bicep Curl', sets: 3, reps: '15', cue: 'Elbows pinned to sides, curl to shoulders, supinate - slow 2s negative', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Biceps', secondaryMuscles: ['Brachialis'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-5', name: 'DB Hammer Curl', sets: 3, reps: '15', cue: 'Neutral grip throughout, elbows pinned - controlled tempo both directions', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['bicep', 'elbow_wrist'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Brachialis', secondaryMuscles: ['Biceps', 'Brachioradialis'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-6', name: 'DB Bent-Over Lateral Raise', sets: 3, reps: '15–20', cue: 'Hinge forward, arms wide, thumbs down - lead with elbows, squeeze rear delts', suggestedLoad: '4–8 kg per hand', category: 'accessory', targetRegions: ['rear_shoulder', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rear deltoid', secondaryMuscles: ['Rhomboids', 'Trapezius'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-7', name: 'DB Arnold Press', sets: 3, reps: '12', cue: 'Start palms-in at chin, rotate as you press overhead - full deltoid sweep', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['front_shoulder', 'rear_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Lateral deltoid', 'Triceps', 'Serratus anterior'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-db-8', name: 'DB Renegade Row', sets: 3, reps: '10 each', cue: 'Plank on DBs, row one to hip without rotating hips - brace hard', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['lat_mid_back', 'core_ribs'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Core', 'Rhomboids', 'Biceps'], difficulty: 'advanced', isUnilateral: true,
      ...
      { id: 'bn-acc-db-9', name: 'DB Chest Fly', sets: 3, reps: '15', cue: 'Slight elbow bend, arms wide, bring DBs together over chest - squeeze pecs, slow 3s return', suggestedLoad: '8–14 kg per hand', category: 'accessory', targetRegions: ['front_shoulder', 'chest'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Front deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-10', name: 'Zottman Curl', sets: 3, reps: '12', cue: 'Curl up with palms forward, rotate to palms down at top, lower slowly - trains both bicep heads and brachioradialis', suggestedLoad: '6–12 kg per hand', category: 'accessory', targetRegions: ['elbow_wrist', 'bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Biceps', secondaryMuscles: ['Brachioradialis', 'Brachialis'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-db-11', name: 'DB Incline Tricep Extension', sets: 3, reps: '12–15', cue: 'Lie on incline bench, lower DBs behind head, extend fully - long head tricep stretch and squeeze', suggestedLoad: '6–12 kg per hand', category: 'accessory', targetRegions: ['elbow_wrist', 'front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Anterior deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-db-12', name: 'Seated DB Shoulder Press', sets: 3, reps: '12', cue: 'Seated upright, DBs at ear height, press straight overhead - full lockout at top, slow 2s descent', suggestedLoad: '10–18 kg per hand', category: 'accessory', targetRegions: ['front_shoulder', 'rear_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Triceps', 'Lateral deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-13', name: 'Standing Overhead Press', sets: 3, reps: '10–12', cue: 'DBs at shoulders, brace core, press overhead - slight lean away from each DB, squeeze at the top', suggestedLoad: '10–18 kg per hand', category: 'accessory', targetRegions: ['front_shoulder', 'core_ribs'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Triceps', 'Core', 'Trapezius'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-db-14', name: 'Dumbbell Front Raise', sets: 3, reps: '15', cue: 'DBs at thighs, raise to shoulder height with slight elbow bend - slow 2s return, no swinging', suggestedLoad: '5–10 kg per hand', category: 'accessory', targetRegions: ['front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Lateral deltoid', 'Serratus anterior'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-15', name: 'Chest Supported Row', sets: 3, reps: '15 each', cue: 'Lie face down on incline bench, pull DBs to hips, squeeze shoulder blades - chest on pad removes all lower back demand', suggestedLoad: '12–20 kg per hand', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Rear deltoid', 'Latissimus dorsi', 'Biceps'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-db-17', name: 'Tate Press', sets: 3, reps: '15', cue: 'Lie on bench, DBs over chest pointing up - keep elbows flared out wide, lower tips to chest then press back to start; constant elbow-out position blasts inner tricep', suggestedLoad: '6–12 kg per hand', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Pectorals', 'Front deltoid'], difficulty: 'intermediate', isUnilateral: false,
    ...
    fullgym: [
      { id: 'bn-acc-fg-1', name: 'Barbell Bent-Over Row', sets: 3, reps: '12–15', cue: 'Flat back, pull to sternum - pump weight, faster reps', suggestedLoad: '40–60 kg', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Rhomboids', 'Biceps', 'Rear deltoid', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-2', name: 'Overhead Press', sets: 3, reps: '10–12', cue: 'Brace core, press through ceiling - pump weight', suggestedLoad: '30–45 kg', category: 'accessory', targetRegions: ['front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Triceps', 'Lateral deltoid', 'Core'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-3', name: 'Cable Tricep Pushdown', sets: 3, reps: '20', cue: 'Elbows pinned, full extension at bottom - constant tension', suggestedLoad: '15–25 kg', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: [], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-4', name: 'Lat Pulldown', sets: 3, reps: '12–15', cue: 'Pull bar to upper chest, drive elbows down - squeeze lats, control the return', suggestedLoad: '40–60 kg', category: 'accessory', targetRegions: ['lat_mid_back', 'bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Biceps', 'Rhomboids', 'Teres major'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-7', name: 'Incline DB Press', sets: 3, reps: '12', cue: 'Bench at 30°, press DBs over upper chest - controlled 2s descent', suggestedLoad: '14–24 kg per hand', category: 'accessory', targetRegions: ['chest', 'front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Upper pectorals', secondaryMuscles: ['Anterior deltoid', 'Triceps'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-8', name: 'Cable Chest Fly', sets: 3, reps: '15', cue: 'Slight elbow bend, sweep hands together in front - squeeze chest 1s', suggestedLoad: '10–20 kg per side', category: 'accessory', targetRegions: ['chest'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Anterior deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-10', name: 'Machine Chest Press', sets: 3, reps: '15–20', cue: 'Back flat on pad, press to full lockout - slow 3s return, constant tension, pump focus', suggestedLoad: '40–70 kg', category: 'accessory', targetRegions: ['front_shoulder', 'chest'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Front deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-13', name: 'Decline Bench Press', sets: 3, reps: '10–12', cue: 'Feet locked in, bench at -15°, lower bar to lower chest - great lower-pec activation, less shoulder strain than flat', suggestedLoad: '50–80 kg', category: 'accessory', targetRegions: ['front_shoulder', 'chest'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Lower pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-15', name: 'JM Press', sets: 3, reps: '12', cue: 'Barbell over forehead, lower toward neck with elbows at 45° then press back to lockout - hybrid of skull crusher and close-grip press, huge tricep stimulus', suggestedLoad: '30–55 kg', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: ['Anterior deltoid', 'Pectorals'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-16', name: 'Weighted Dips', sets: 3, reps: '8–10', cue: 'Belt or vest with added weight, slight forward lean - lower until shoulders at elbow depth, drive hard back to top', suggestedLoad: '10–30 kg added', category: 'accessory', targetRegions: ['front_shoulder', 'elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Pectorals', secondaryMuscles: ['Triceps', 'Anterior deltoid'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-20', name: 'Single Arm Cable Extension', sets: 3, reps: '15 each', cue: 'High cable, single handle, push down keeping elbow pinned - unilateral isolation reveals and fixes side imbalances', suggestedLoad: '8–15 kg', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Triceps', secondaryMuscles: [], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'bn-acc-fg-21', name: 'Cable Front Raise', sets: 3, reps: '15', cue: 'Low cable, single handle or bar, raise to shoulder height with slight elbow bend - constant tension from cable throughout the range', suggestedLoad: '8–15 kg', category: 'accessory', targetRegions: ['front_shoulder'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Lateral deltoid'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'bn-acc-fg-22', name: 'Landmine Press', sets: 3, reps: '10 each', cue: 'Barbell anchored at floor, press from shoulder along the angled arc - shoulder-friendly pressing that loads the upper chest and deltoid without full overhead range', suggestedLoad: '20–40 kg', category: 'accessory', targetRegions: ['front_shoulder', 'chest'], videoId: '',
        movementPattern: 'push', primaryMuscle: 'Anterior deltoid', secondaryMuscles: ['Upper pectorals', 'Triceps', 'Core'], difficulty: 'intermediate', isUnilateral: true,
  ...
  deadlift: {
    bodyweight: [
      { id: 'dl-acc-bw-1', name: 'Glute Bridge March', sets: 3, reps: '15 each', cue: 'Hips level throughout, alternate legs - glutes stay engaged', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Core', 'Hamstrings'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'dl-acc-bw-2', name: 'Superman Hold', sets: 3, reps: '10 (3s holds)', cue: 'Lift arms and legs, squeeze back - lower back hypertrophy', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['upper_back', 'lower_back'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Erector spinae', secondaryMuscles: ['Glutes', 'Rhomboids', 'Trapezius'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-3', name: 'Bear Crawl', sets: 3, reps: '20 steps forward', cue: 'Knees hover 2cm off ground, move contralateral limbs - tight core', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs', 'front_shoulder'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Core', secondaryMuscles: ['Shoulder stabilizers', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-7', name: 'Reverse Hyperextension (floor)', sets: 3, reps: '15', cue: 'Face down, legs long, lift both legs and squeeze glutes - no lower back arch', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['glutes', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Erector spinae'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-8', name: 'Hollow Body Hold', sets: 3, reps: '30s', cue: 'Lower back pressed to floor, arms and legs extended - brace and breathe', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Rectus abdominis', 'Hip flexors'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-9', name: 'Copenhagen Plank', sets: 3, reps: '20s each', cue: 'Side plank with top leg on bench, bottom leg free - hip adductor and lateral core work; keep hips stacked', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'core_ribs'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Hip adductors', secondaryMuscles: ['Core', 'Glute medius'], difficulty: 'advanced', isUnilateral: true,
      ...
      { id: 'dl-acc-bw-10', name: 'Banded Pallof Press', sets: 3, reps: '12 each', cue: 'Band anchored at chest height, press out and hold 2s then return - resist the rotation, core stays braced', suggestedLoad: 'Medium band', category: 'accessory', targetRegions: ['core_ribs'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Obliques', 'Glutes'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'dl-acc-bw-11', name: 'Donkey Kick', sets: 3, reps: '15 each', cue: 'All fours, drive heel to ceiling, squeeze glute at top - keep hips level and spine neutral throughout', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Lower back'], difficulty: 'beginner', isUnilateral: true,
      ...
      { id: 'dl-acc-bw-13', name: 'Dead Hang', sets: 3, reps: '30–45s', cue: 'Hang from bar with straight arms - let gravity decompress the spine, keep shoulders active (not fully shrugged or fully collapsed)', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['lat_mid_back', 'elbow_wrist'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Latissimus dorsi', 'Shoulder stabilizers'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-14', name: 'Hanging Leg Raise', sets: 3, reps: '10–12', cue: 'Dead hang, brace core, raise both legs to at least parallel - control the return, no swinging', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs', 'hip_groin'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Hip flexors', secondaryMuscles: ['Rectus abdominis', 'Grip/Forearms'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-15', name: 'Stability Ball Hamstring Curl', sets: 3, reps: '12–15', cue: 'Lying on back, heels on stability ball, bridge hips up and curl ball toward glutes - hamstrings load eccentrically and concentrically', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hamstrings', 'glutes', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Core'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-bw-17', name: 'Ab Wheel Rollout', sets: 3, reps: '10', cue: 'Kneel, grip wheel, roll forward extending arms until hips nearly touch floor - brace core hard and pull wheel back; one of the best core exercises', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['core_ribs', 'lower_back'], videoId: '',
        movementPattern: 'isometric', primaryMuscle: 'Transversus abdominis', secondaryMuscles: ['Lats', 'Obliques', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
    ...
    dumbbells: [
      ...
      { id: 'dl-acc-db-2', name: 'DB Bent-Over Row', sets: 3, reps: '15 each', cue: 'Flat back, pull to hip, squeeze lat - pump focus', suggestedLoad: '14–20 kg per hand', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Rhomboids', 'Biceps', 'Rear deltoid'], difficulty: 'intermediate', isUnilateral: true,
      ...
      { id: 'dl-acc-db-3', name: 'KB Swing', sets: 3, reps: '20', cue: 'Hip snap, arms are ropes - bell floats to chest height', suggestedLoad: '14–20 kg', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-db-4', name: 'DB Shrug', sets: 3, reps: '15', cue: 'DBs at sides, shrug straight up, 1s squeeze at top - no rolling', suggestedLoad: '20–32 kg per hand', category: 'accessory', targetRegions: ['upper_back', 'neck'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Trapezius', secondaryMuscles: ['Levator scapulae'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-db-8', name: 'DB Sumo Deadlift', sets: 3, reps: '12', cue: 'Wide stance, toes out, DBs between legs - sit into hips, drive through heels, squeeze glutes at top', suggestedLoad: '16–28 kg per hand', category: 'accessory', targetRegions: ['hip_groin', 'hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Adductors', secondaryMuscles: ['Glutes', 'Hamstrings', 'Lower back'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-db-9', name: 'DB Farmer Carry', sets: 3, reps: '40m', cue: 'Heavy DBs at sides, walk tall with braced core - grip, core, and trap endurance', suggestedLoad: '24–36 kg per hand', category: 'accessory', targetRegions: ['core_ribs', 'upper_back'], videoId: '',
        movementPattern: 'carry', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Trapezius', 'Core', 'Glutes'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-db-10', name: 'DB Power Clean', sets: 3, reps: '8', cue: 'Deadlift start, explosive hip drive, shrug and catch in quarter-squat - power from the hips not the arms', suggestedLoad: '12–20 kg per hand', category: 'accessory', targetRegions: ['hip_groin', 'upper_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Trapezius', 'Hamstrings', 'Core'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'dl-acc-db-11', name: 'Stiff Leg Deadlift', sets: 3, reps: '12', cue: 'DBs in hands, almost straight knees throughout - hinge until you feel a strong hamstring stretch, drive hips through to lockout; more hamstring stretch than RDL', suggestedLoad: '14–22 kg per hand', category: 'accessory', targetRegions: ['hamstrings', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-db-12', name: 'Chin-Up', sets: 3, reps: '6–10', cue: 'Underhand grip, full hang - drive elbows down and back to pull chin over bar; supinated grip allows more bicep involvement than pull-up', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['lat_mid_back', 'bicep'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Biceps', 'Rear deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-db-13', name: 'Lying Hamstring Curl', sets: 3, reps: '15', cue: 'Lie face down, DB held between feet - curl heels to glutes, squeeze 1s at top, slow 3s release; isolates the hamstring flex without any hinge pattern', suggestedLoad: '6–14 kg', category: 'accessory', targetRegions: ['hamstrings', 'knee'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Calves'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-db-15', name: 'Fat Grip Hold', sets: 3, reps: '30–45s', cue: 'DBs held at sides with fat grip wraps (or thick-handled DBs) - stand tall, hold as long as possible; extreme grip and forearm strength builder', suggestedLoad: '24–40 kg per hand', category: 'accessory', targetRegions: ['elbow_wrist', 'upper_back'], videoId: '',
        movementPattern: 'carry', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Trapezius', 'Core'], difficulty: 'intermediate', isUnilateral: false,
    ...
    fullgym: [
      ...
      { id: 'dl-acc-fg-2', name: 'Pendlay Row', sets: 3, reps: '12', cue: 'Dead stop each rep, explosive pull - back strength support', suggestedLoad: '40–60 kg', category: 'accessory', targetRegions: ['upper_back', 'rear_shoulder'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Rhomboids', 'Biceps', 'Rear deltoid', 'Erector spinae'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-4', name: 'Cable Pull-Through', sets: 3, reps: '15', cue: 'Rope between legs, hinge back then snap hips forward - squeeze glutes at top', suggestedLoad: '20–35 kg', category: 'accessory', targetRegions: ['glutes', 'hamstrings'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Core', 'Erector spinae'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-5', name: 'T-Bar Row', sets: 3, reps: '12', cue: 'Hinge over bar, neutral grip, pull to chest - squeeze mid-back, control down', suggestedLoad: '30–50 kg', category: 'accessory', targetRegions: ['upper_back', 'lat_mid_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Latissimus dorsi', 'Biceps', 'Rear deltoid'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-6', name: 'Rack Pull', sets: 3, reps: '8–10', cue: 'Bar set just below knees, drive hips through, squeeze glutes - flat back', suggestedLoad: '60–100 kg', category: 'accessory', targetRegions: ['lower_back', 'glutes', 'upper_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Erector spinae', secondaryMuscles: ['Glutes', 'Hamstrings', 'Trapezius'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-8', name: 'Romanian Deadlift', sets: 3, reps: '12', cue: 'Bar at hips, push them back, hinge until hamstrings load then drive through - posterior chain pump', suggestedLoad: '60–100 kg', category: 'accessory', targetRegions: ['hamstrings', 'hip_groin'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Lower back'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-10', name: 'Reverse Hyperextension', sets: 3, reps: '15', cue: 'Hips on bench or GHD pad, legs hanging, lift legs to parallel - posterior chain pump with spinal decompression', suggestedLoad: '0–20 kg ankle weight', category: 'accessory', targetRegions: ['hip_groin', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Glutes', secondaryMuscles: ['Hamstrings', 'Erector spinae'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-11', name: 'Glute Ham Raise', sets: 3, reps: '8–10', cue: 'GHD machine, feet anchored, lower torso under control then pull back up using hamstrings only - one of the best posterior chain exercises; incredibly demanding', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['hamstrings', 'glutes', 'lower_back'], videoId: '',
        movementPattern: 'hinge', primaryMuscle: 'Hamstrings', secondaryMuscles: ['Glutes', 'Erector spinae', 'Calves'], difficulty: 'advanced', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-14', name: 'Straight Arm Pulldown', sets: 3, reps: '15', cue: 'High cable, straight-arm bar or rope, pull down to thighs keeping arms straight - pure lat isolation without any elbow flexion', suggestedLoad: '15–30 kg', category: 'accessory', targetRegions: ['lat_mid_back', 'upper_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Latissimus dorsi', secondaryMuscles: ['Teres major', 'Core'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-15', name: 'Seal Row', sets: 3, reps: '12', cue: 'Lie face down on elevated bench, barbell or DBs hanging below, row up to chest - chest braced on bench removes lower back entirely from the equation', suggestedLoad: '30–60 kg', category: 'accessory', targetRegions: ['upper_back', 'lat_mid_back'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Rhomboids', secondaryMuscles: ['Rear deltoid', 'Latissimus dorsi', 'Biceps'], difficulty: 'intermediate', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-17', name: 'Dead Hangs', sets: 3, reps: '30–60s', cue: 'Grip the bar, hang with completely straight arms - decompress spine, build grip endurance, and strengthen shoulder stabilizers passively', suggestedLoad: 'Bodyweight', category: 'accessory', targetRegions: ['lat_mid_back', 'elbow_wrist'], videoId: '',
        movementPattern: 'pull', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Shoulder stabilizers', 'Latissimus dorsi'], difficulty: 'beginner', isUnilateral: false,
      ...
      { id: 'dl-acc-fg-18', name: 'Plate Pinch Holds', sets: 3, reps: '30s each hand', cue: 'Pinch two plates together smooth-sides-out with just fingers and thumb - pure finger strength; walk slowly or just stand', suggestedLoad: '2 × 10 kg plates', category: 'accessory', targetRegions: ['elbow_wrist'], videoId: '',
        movementPattern: 'carry', primaryMuscle: 'Grip/Forearms', secondaryMuscles: ['Finger flexors'], difficulty: 'intermediate', isUnilateral: true,
...
const PREHAB_BY_REGION: Record<PainRegion, ExerciseTemplate[]> = {
  ...
  chest: [
    { id: 'ph-r-ch-1', name: 'Doorway Chest Stretch', sets: 2, reps: '45s each side', cue: 'Arm at 90°, step through doorway - breathe into the pec stretch, no pushing or forcing', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['chest', 'front_shoulder'], videoId: '' },
    { id: 'ph-r-ch-2', name: 'Incline Push-Up (slow)', sets: 3, reps: '10 slow reps', cue: 'Hands elevated on bench or step, 3s down - reduce chest stretch depth to manage soreness', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['chest', 'front_shoulder'], videoId: '' },
    { id: 'ph-r-ch-3', name: 'Pec Minor Stretch', sets: 2, reps: '45s each side', cue: 'Arm at 120° in doorway - targets the pec minor specifically, breathe and relax', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['chest', 'front_shoulder'], videoId: '' },
    { id: 'ph-r-ch-4', name: 'Band Pull-Apart', sets: 3, reps: '15 slow reps', cue: 'Arms straight at shoulder height - pull band to sternum, opens chest and counters pressing load', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['chest', 'rear_shoulder'], videoId: '' },
    { id: 'ph-r-ch-5', name: 'Foam Roll Thoracic Extension', sets: 2, reps: '30s at each level', cue: 'Roll thoracic spine section by section - opens up the anterior chest after heavy pressing sessions', suggestedLoad: 'Foam roller', category: 'prehab', targetRegions: ['chest', 'upper_back'], videoId: '' },
  ],
  bicep: [
    { id: 'ph-r-bi-1', name: 'Bicep Stretch (arm back)', sets: 2, reps: '45s each side', cue: 'Arm behind body, palm up, gentle shoulder extension - feel the bicep and anterior shoulder lengthen', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['bicep', 'front_shoulder'], videoId: '' },
    { id: 'ph-r-bi-2', name: 'Forearm Supination / Pronation', sets: 2, reps: '15 each direction', cue: 'Elbow at 90°, slowly rotate palm up then down - bicep tendon health and radioulnar joint mobility', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['bicep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-bi-3', name: 'Band Curl (light, high reps)', sets: 3, reps: '20 reps', cue: 'Light band, full range - slow eccentric. Keeps blood flowing without overloading the sore muscle', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['bicep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-bi-4', name: 'Wrist Flexor Stretch', sets: 2, reps: '30s each side', cue: 'Arm extended, palm up, gently pull fingers back - releases the flexors that share load with the bicep', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['bicep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-bi-5', name: 'Cross-Body Shoulder Stretch', sets: 2, reps: '30s each side', cue: 'Pull arm across chest - rear deltoid and bicep long head decompression', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['bicep', 'rear_shoulder'], videoId: '' },
  ],
  tricep: [
    { id: 'ph-r-tr-1', name: 'Overhead Tricep Stretch', sets: 2, reps: '45s each side', cue: 'Arm overhead, bend elbow, push with opposite hand - feel the long head of the tricep lengthen', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['tricep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-tr-2', name: 'Cross-Body Tricep Stretch', sets: 2, reps: '30s each side', cue: 'Pull bent arm across chest - targets the lateral and medial head of the tricep', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['tricep', 'rear_shoulder'], videoId: '' },
    { id: 'ph-r-tr-3', name: 'Band Pushdown (light, high reps)', sets: 3, reps: '20 reps', cue: 'Light band, elbows pinned - full extension, slow release. Active recovery for the tricep without loading', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['tricep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-tr-4', name: 'Wrist Extensor Stretch', sets: 2, reps: '30s each side', cue: 'Arm extended, palm down, pull fingers toward you - releases lateral elbow and tricep tendon area', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['tricep', 'elbow_wrist'], videoId: '' },
    { id: 'ph-r-tr-5', name: 'Wall Angel', sets: 2, reps: '10 slow reps', cue: 'Back flat on wall, slide arms up and down - scapular and elbow mobility to relieve tricep loading', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['tricep', 'rear_shoulder', 'upper_back'], videoId: '' },
  ],
  quads: [
    { id: 'ph-r-qu-1', name: 'Standing Quad Stretch', sets: 2, reps: '45s each side', cue: 'Hand on wall, pull heel to glute - breathe into the front thigh stretch, keep knees together', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['quads', 'knee'], videoId: '' },
    { id: 'ph-r-qu-2', name: 'Terminal Knee Extension (band)', sets: 3, reps: '15 each side', cue: 'Band behind knee, straighten fully against resistance, hold 1s - VMO and quad activation without deep bend', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['quads', 'knee'], videoId: '' },
    { id: 'ph-r-qu-3', name: 'Slow Step-Down (eccentric)', sets: 3, reps: '10 each side', cue: 'Stand on step, lower heel to floor in 3s - eccentric quad loading with minimal volume', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['quads', 'knee'], videoId: '' },
    { id: 'ph-r-qu-4', name: 'Couch Stretch', sets: 2, reps: '45s each side', cue: 'Rear foot on couch or wall, kneeling lunge - deep quad and hip flexor stretch for post-training soreness', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['quads', 'hip_groin'], videoId: '' },
    { id: 'ph-r-qu-5', name: 'Isometric Wall Sit', sets: 2, reps: '30s', cue: 'Thighs parallel, back flat - hold, breathe. Isometric quad load without the eccentric stress', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['quads', 'knee'], videoId: '' },
  ],
  hamstrings: [
    { id: 'ph-r-hm-1', name: 'Standing Hamstring Stretch', sets: 2, reps: '45s each side', cue: 'Foot on low surface, hinge forward - feel the posterior chain lengthen, no rounding of the spine', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['hamstrings', 'lower_back'], videoId: '' },
    { id: 'ph-r-hm-2', name: 'Supine Hamstring Stretch (strap)', sets: 2, reps: '45s each side', cue: 'Lie on back, loop towel around foot - straighten knee until gentle tension, hold and breathe', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['hamstrings', 'knee'], videoId: '' },
    { id: 'ph-r-hm-3', name: 'Nordic Curl Negative (slow)', sets: 3, reps: '5 reps', cue: 'Ankles secured, lower body forward in 5s - eccentric hamstring loading at its most effective', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['hamstrings', 'knee'], videoId: '' },
    { id: 'ph-r-hm-4', name: 'Hip Hinge Against Wall', sets: 3, reps: '15 slow reps', cue: 'Hands on wall, push hips back - feel hamstring stretch at bottom, drive glutes to stand. Deload version of RDL', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['hamstrings', 'lower_back'], videoId: '' },
    { id: 'ph-r-hm-5', name: 'Pigeon Pose', sets: 2, reps: '45s each side', cue: 'Front shin horizontal, breathe into outer hip - releases hip external rotators which assist hamstring function', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['hamstrings', 'hip_groin'], videoId: '' },
  ],
  glutes: [
    { id: 'ph-r-gl-1', name: 'Banded Clamshell', sets: 3, reps: '15 each side', cue: 'Band above knees, feet together - rotate top knee up, hold 1s, lower slowly. Glute med activation', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['glutes', 'hip_groin'], videoId: '' },
    { id: 'ph-r-gl-2', name: 'Glute Bridge (isometric hold)', sets: 3, reps: '10 reps, 5s hold each', cue: 'Push through heels, squeeze glutes hard at top - isometric loading without the soreness-inducing eccentric', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['glutes', 'lower_back'], videoId: '' },
    { id: 'ph-r-gl-3', name: 'Pigeon Pose', sets: 2, reps: '60s each side', cue: 'Front shin horizontal, breathe deeply - releases the piriformis and deep external rotators of the glute', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['glutes', 'hip_groin'], videoId: '' },
    { id: 'ph-r-gl-4', name: 'Lateral Band Walk', sets: 2, reps: '15 steps each direction', cue: 'Band around ankles, slight squat position - step sideways, toes forward. Glute med and lateral chain', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['glutes', 'hip_groin'], videoId: '' },
    { id: 'ph-r-gl-5', name: '90/90 Hip Stretch', sets: 2, reps: '45s each side', cue: 'On back, figure-4 position - breathe and let the outer glute and piriformis release', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['glutes', 'hip_groin'], videoId: '' },
  ],
  lat_mid_back: [
    { id: 'ph-r-lm-1', name: 'Child\'s Pose with Side Reach', sets: 2, reps: '45s each side', cue: 'From child\'s pose, walk hands to one side - feel the lat and QL stretch on the opposite side', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['lat_mid_back', 'lower_back'], videoId: '' },
    { id: 'ph-r-lm-2', name: 'Thread-the-Needle Rotation', sets: 2, reps: '8 each side, hold 3s', cue: 'All fours, thread arm under body - thoracic rotation that releases mid-back and lat tension', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['lat_mid_back', 'upper_back'], videoId: '' },
    { id: 'ph-r-lm-3', name: 'Band Pull-Apart', sets: 3, reps: '15 slow reps', cue: 'Arms at shoulder height, pull band to sternum - mid-trap and rhomboid activation to balance lat soreness', suggestedLoad: 'Light band', category: 'prehab', targetRegions: ['lat_mid_back', 'rear_shoulder'], videoId: '' },
    { id: 'ph-r-lm-4', name: 'Book Opener (thoracic rotation)', sets: 2, reps: '8 each side', cue: 'Side-lying, knees stacked, sweep top arm back - breathe into the stretch, T-spine rotation and lat release', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['lat_mid_back', 'upper_back'], videoId: '' },
    { id: 'ph-r-lm-5', name: 'Doorway Lat Stretch', sets: 2, reps: '30s each side', cue: 'Grip doorframe at hip height, sit back and lean away - direct lat lengthening after pulling work', suggestedLoad: 'Bodyweight', category: 'prehab', targetRegions: ['lat_mid_back', 'lower_back'], videoId: '' },
  ],
};
