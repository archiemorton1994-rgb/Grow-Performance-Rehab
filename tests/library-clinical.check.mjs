...
// and argued with on its own. Push (8), Pull (4), Hinge (6) and Squat (9) are
// written, so 149 of the 160. The number reaches 160 when the last one lands.
...
check(
  `149 of the 160 movement records are written (${authoredMovement.length})`,
  authoredMovement.length === 149,
