...
export function PainInsightSheet({
  ...
  return (
    <Modal visible={region !== null} transparent animationType="slide" onRequestClose={onDismiss}>
      <Pressable
      ...
      >
        ...
        >
          ...
          >
            A targeted prehab circuit strengthens and protects this area, reducing injury risk over
            time.
          </Text>
          ...
          <Pressable
            ...
            onPress={() => {
              if (region) onStartPrehab(region);
            }}
            style={({ pressed }) => [
              {
          ...
          <Pressable
            ...
            onPress={() => {
              if (region) onViewHistory(region);
            }}
            style={({ pressed }) => [
              {
                alignItems: 'center' as const,
