...
export function BodyDiagram({
  ...
  const renderFrontHotspots = () => (
    <G>
      ...
      <Path d="M 50,72 C 38,70 22,68 10,72 C 2,76 0,88 0,102 C 0,116 4,128 12,136 C 18,142 28,146 38,144 C 48,142 54,134 54,122 L 54,94 Z" {...h('front_shoulder')} />
      <Path d="M 150,72 C 162,70 178,68 190,72 C 198,76 200,88 200,102 C 200,116 196,128 188,136 C 182,142 172,146 162,144 C 152,142 146,134 146,122 L 146,94 Z" {...h('front_shoulder')} />
      {/* Chest */}
      <Path d="M 52,76 C 56,70 66,68 76,68 C 84,68 92,72 98,78 L 100,82 C 98,96 94,110 88,122 C 80,126 70,126 62,122 C 56,118 52,108 52,96 Z" {...h('chest')} />
      <Path d="M 148,76 C 144,70 134,68 124,68 C 116,68 108,72 102,78 L 100,82 C 102,96 106,110 112,122 C 120,126 130,126 138,122 C 144,118 148,108 148,96 Z" {...h('chest')} />
      {/* Biceps — significantly enlarged tap targets covering the upper arm */}
      <Path d="M 0,88 C 0,104 2,120 6,134 C 10,146 18,154 30,152 C 42,150 50,140 50,126 C 50,110 44,96 36,90 C 26,84 10,82 0,88 Z" {...h('bicep')} />
      <Path d="M 200,88 C 200,104 198,120 194,134 C 190,146 182,154 170,152 C 158,150 150,140 150,126 C 150,110 156,96 164,90 C 174,84 190,82 200,88 Z" {...h('bicep')} />
      {/* Triceps — also accessible from front view (back of upper arm, lateral reach) */}
      <Path d="M 0,90 C 0,108 2,124 6,138 C 10,150 20,158 32,156 C 44,154 52,142 52,128 C 52,112 46,98 38,92 C 28,86 10,84 0,90 Z" {...h('tricep')} />
      <Path d="M 200,90 C 200,108 198,124 194,138 C 190,150 180,158 168,156 C 156,154 148,142 148,128 C 148,112 154,98 162,92 C 172,86 190,84 200,90 Z" {...h('tricep')} />
      {/* Forearm / Elbow+Wrist */}
      <Path d="M 8,154 C 4,168 2,184 2,200 C 2,212 4,222 10,228 C 16,234 24,234 30,228 C 36,222 38,210 38,196 C 38,182 36,168 32,156 C 24,150 12,150 8,154 Z" {...h('elbow_wrist')} />
      <Path d="M 192,154 C 196,168 198,184 198,200 C 198,212 196,222 190,228 C 184,234 176,234 170,228 C 164,222 162,210 162,196 C 162,182 164,168 168,156 C 176,150 188,150 192,154 Z" {...h('elbow_wrist')} />
      {/* Core / Ribs */}
  ...
  const renderBackHotspots = () => (
    <G>
      ...
      <Path d="M 50,72 C 38,70 22,68 10,72 C 2,76 0,88 0,102 C 0,116 4,128 12,136 C 18,142 28,146 38,144 C 48,142 54,134 54,122 L 54,94 Z" {...h('rear_shoulder')} />
      <Path d="M 150,72 C 162,70 178,68 190,72 C 198,76 200,88 200,102 C 200,116 196,128 188,136 C 182,142 172,146 162,144 C 152,142 146,134 146,122 L 146,94 Z" {...h('rear_shoulder')} />
      ...
      <Path d="M 192,154 C 196,168 198,184 198,200 C 198,212 196,222 190,228 C 184,234 176,234 170,228 C 164,222 162,210 162,196 C 162,182 164,168 168,156 C 176,150 188,150 192,154 Z" {...h('elbow_wrist')} />
      {/* Upper back */}
      <Path d="M 100,64 C 88,70 76,82 70,96 C 66,106 66,118 70,128 C 74,136 84,140 94,140 L 106,140 C 116,140 126,136 130,128 C 134,118 134,106 130,96 C 124,82 112,70 100,64 Z" {...h('upper_back')} />
      {/* Lats / Mid back */}
      <Path d="M 50,76 C 44,88 40,102 36,118 C 32,132 30,146 30,160 C 30,172 32,180 38,186 C 44,190 52,190 56,184 C 60,176 62,160 62,144 C 62,128 62,112 62,98 C 62,88 60,80 58,76 Z" {...h('lat_mid_back')} />
      <Path d="M 150,76 C 156,88 160,102 164,118 C 168,132 170,146 170,160 C 170,172 168,180 162,186 C 156,190 148,190 144,184 C 140,176 138,160 138,144 C 138,128 138,112 138,98 C 138,88 140,80 142,76 Z" {...h('lat_mid_back')} />
      {/* Lower back */}
