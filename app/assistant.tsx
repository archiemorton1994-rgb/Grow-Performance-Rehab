...
const styles = StyleSheet.create({
  ...
  glanceValue: { fontSize: 20, fontFamily: 'Inter_700Bold' },
  glanceLabel: { fontSize: 11, fontFamily: 'Inter_500Medium', letterSpacing: 0.4, opacity: 0.75 },
  ...
  sectionSub: { fontSize: 13, fontFamily: 'Inter_400Regular', marginTop: 1 },
  countPill: { minWidth: 24, paddingHorizontal: 7, paddingVertical: 2, borderRadius: 10 },
  countPillText: { fontSize: 13, fontFamily: 'Inter_700Bold', textAlign: 'center' },
