...
import { READINESS_TUTORIAL } from '@/lib/readiness-screen';
...
// The three cards that talk over this screen live in lib/readiness-screen.ts,
// where a node check can import them and read what they say. See the note at
// the top of that file: the comments explaining this copy quote the phrases
// the copy is not allowed to contain, so a check that greps them passes on
// the wrong text.
